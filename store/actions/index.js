import {GET_COVID_DATA, GET_COVID_DEATH_BYDAY, GET_COVID_DATA_AFRICA} from './types'
import axios from 'axios';
const maps = require('../../pages/countryMap/mapdata/africa');
...
export  const mapAnalysis = () => async dispatch => {
// Country id
